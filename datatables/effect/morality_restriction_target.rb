module Effect
	class MoralityRestrictionTarget

		def save_state_to_datatable
			{type: 'MoralityRestrictionTarget', text_1: @mo_min, text_2: @mo_max}
		end

		def self.save_state_from_datatable(parent, table)
			['MoralityRestrictionTarget', table[:text_1].to_i, table[:text_2].to_i]
		end
